...
Com.Tencent.Advertisement（广告插件，必须删。）
...
Com.Tencent.DingDong（QQ7.8新增的应用“事项”，后改名为“回执消息”，目前已下架。从QQ9.0.3开始，好友聊天窗口里前台显示接收的消息也需要此插件。QQ9.2.1版本开始下架了。）

Com.Tencent.FileTransfer（重要组件，发送接收文件。）

Com.Tencent.GameLife（游戏人生，腾讯游戏爱好者需要，不用可删。）

Com.Tencent.Graffito（QQ8.8已移除了涂鸦编辑和魔法表情，取而代之的是表情DIY，已经不依赖这个插件，可删。）

Com.Tencent.HRTX（基本没人用的，叫什么腾讯通，可删。）

Com.Tencent.IOT（智能物联？对大多人没有什么用，可删。）

Com.Tencent.Mail（邮件，删除后没有快捷邮箱入口，也不会提示有新邮件。）

Com.Tencent.Memo（备忘录已下线，原内容已迁移到“我的收藏”，不依赖此插件，可删。）
...
Com.Tencent.QQPet（QQ宠物，不用可删。9.x版本后已经下线了。）

Com.Tencent.QQRing（会员炫铃，不用可删。9.x版本后已经下线了。）
...
Com.Tencent.Soso（腾讯搜搜，聊天窗口那个搜索图标和涂黑聊天信息显示搜索，可删。9.x版本已经下线了。）

Com.Tencent.Stock（财经股票，专业玩股票的估计也不用腾讯的这东西，可删。）

Com.Tencent.Today（迷你腾讯，和QQ订阅相互关联，可删。）

Com.Tencent.Tribe（兴趣部落，兴趣社交产品，帮助你找到趣味相投的那群人，可删。9.x版本下线了。）

Com.Tencent.VAS（会员增值服务，会员专用。）

Com.Tencent.WBlog（腾讯微博，项目组都解散了，还留着干毛，删。）

Com.Tencent.Weather（腾讯天气）

Com.Tencent.WenWen（随着腾讯搜搜业务的死掉，这东西真没必要留着，删。）
